      ...
      <div className="flex items-center justify-center gap-40 px-6">
        ...
        <div className="flex-1 flex flex-col gap-10">
          ...
          <p className="font-secondary font-normal text-base md:text-xl leading-[35px] tracking-[1%] max-w-lg">
            At NSK.ai we believe great AI learning is communal, hands-on, and accessible. Our blog
            brings together clear explainers, project walk-throughs, research summaries, career
            guides, and community stories.
          </p>

          {/* CTA — links to blog list on all screen sizes */}
          <div>
            <Link to="/blog" className="hidden lg:inline-block">
              <button className="bg-white px-6 py-5 text-[#101213] rounded-[45px] flex items-center justify-center gap-5 text-base font-secondary font-semibold leading-[146%] cursor-pointer transition-all duration-300 hover:shadow-[0_0_15px_#ff4d4d]">
            ...
            <button
              ...
              className="bg-white px-6 py-5 text-[#101213] rounded-[45px] flex items-center justify-center gap-5 text-base font-secondary font-semibold leading-[146%] cursor-pointer lg:hidden transition-all duration-300 hover:shadow-[0_0_15px_#ff4d4d]"
            >
              Read More <img src={ArrowRight} alt="" />
            </button>
          </div>
        ...
        <div className="hidden lg:block lg:flex-1 lg:h-[550px] lg:relative">
          <img
            ...
            className="w-full h-full outline-[5px] outline-white rounded-[15px] object-cover"
          />
          <img
            src={Featured}
            alt="Featured"
